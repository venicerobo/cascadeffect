...
#pragma config(Sensor, S1,     IRfront,        sensorI2CMuxController)
#pragma config(Sensor, S2,     IRright,        sensorHiTechnicIRSeeker1200)
#pragma config(Sensor, S3,     SONAR,          sensorSONAR)
#pragma config(Motor,  mtr_S1_C1_1,     left_wheel,    tmotorTetrix, openLoop, encoder)
#pragma config(Motor,  mtr_S1_C1_2,     right_wheel,   tmotorTetrix, openLoop, encoder)
#pragma config(Motor,  mtr_S1_C2_1,     right_lift_up, tmotorTetrix, openLoop, encoder)
#pragma config(Motor,  mtr_S1_C2_2,     spinner,       tmotorTetrix, openLoop)
#pragma config(Motor,  mtr_S1_C3_1,     left_lift_down, tmotorTetrix, openLoop)
#pragma config(Motor,  mtr_S1_C3_2,     motorI,        tmotorTetrix, openLoop)
#pragma config(Servo,  srvo_S1_C4_1,    left_clamp,           tServoStandard)
#pragma config(Servo,  srvo_S1_C4_2,    right_clamp,          tServoStandard)
