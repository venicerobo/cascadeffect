...
#pragma config(Motor,  mtr_S2_C1_1,     scissor_lift_up, tmotorTetrix, openLoop, encoder)
#pragma config(Motor,  mtr_S2_C1_2,     right_wheel,   tmotorTetrix, openLoop, encoder)
#pragma config(Motor,  mtr_S3_C1_1,     booster,       tmotorTetrix, openLoop)
...
const int LEFT_CLAMP_OPEN = 0;
const int LEFT_CLAMP_CLOSE = 180;
const int RIGHT_CLAMP_OPEN = LEFT_CLAMP_CLOSE;
const int RIGHT_CLAMP_CLOSE = LEFT_CLAMP_OPEN;
...
void initializeRobot()
{
  ...
  // Sensors are automatically configured and setup by ROBOTC. They may need a brief time to stabilize.
	servo[left_grabber] = LEFT_CLAMP_OPEN;
	servo[right_grabber] = RIGHT_CLAMP_OPEN;
	wait1Msec(500);
	servo[left_grabber] = LEFT_CLAMP_CLOSE;
	servo[right_grabber] = RIGHT_CLAMP_CLOSE;
  return;
}
...
task main()
{
  ...
  while (true)
  {
  	...
  	servo[left_grabber] = LEFT_CLAMP_OPEN;
  	wait1Msec(1000);
  	// SECOND STAGE: little slower
  	motor[left_wheel] = 1;
  	motor[right_wheel] = -60;
  	wait1Msec(1200);
  	// pause
  	motor[left_wheel] = 0;
  	motor[right_wheel] = 0;
  	wait1Msec(500);
  	// THIRD STAGE: real slow
  	motor[left_wheel] = 0;
